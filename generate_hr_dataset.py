...
This script creates a synthetic HR dataset of 8,950 employees using Faker, NumPy, and pandas.
It includes location, job, education, salary, demographic, and performance-related fields.
